...
window.WORTE_EN = {
  ...
  "Spiele": "Games",
  "Impostor": "Impostor",
  "Impostoren": "Impostors",
  "Zum Spiel einladen": "Invite to a game",
  "Noch kein Spiel. Lade jemanden ein.": "No game yet. Invite someone.",
  "Einladung von": "Invitation from",
  "Alle bekommen dasselbe Wort, einer nur einen Tipp. Ab drei Leuten.":
    "Everyone gets the same word, one person only a hint. Three people or more.",
  "Zwei Teams finden ihre Wörter auf einem Feld aus 25 Karten. Ab vier Leuten.":
    "Two teams find their words on a board of 25 cards. Four people or more.",
  "Zwei Teams, ab vier Leuten.": "Two teams, four people or more.",
  "Lade mindestens drei Personen ein.": "Invite at least three people.",
  ...
  "Rot": "Red",
  "Blau": "Blue",
  "Teams aufstellen": "Pick the teams",
  "Teams werden aufgestellt": "Picking the teams",
  "Neu losen": "Draw again",
  "Los geht's": "Let's go",
  "Zum Chef machen": "Make spymaster",
  "Ins andere Team": "Move to the other team",
  "Chef: sieht, welche Karte zu wem gehört, und gibt die Hinweise.":
    "Spymaster: sees which card belongs to whom and gives the clues.",
  "Noch ohne Antwort": "No answer yet",
  "ist dran": "to play",
  "hat gewonnen": "won",
  "gewinnt!": "wins!",
  "Der Attentäter wurde aufgedeckt.": "The assassin was uncovered.",
  "Hinweis": "Clue",
  "Warten auf den Hinweis …": "Waiting for the clue …",
  "Du schaust zu.": "You are watching.",
  "Du bist Chef von": "You are the spymaster of",
  "Du ermittelst für": "You are an operative for",
  "Ein Wort": "One word",
  "Anzahl": "Number",
  "Hinweis geben": "Give the clue",
  "Zug beenden": "End the turn",
  "Bisherige Hinweise": "Earlier clues",
  "Suchen …": "Search …",
  "Nichts gefunden.": "Nothing found.",
  "Tippe ein Wort an, um es aus dem Spiel zu nehmen oder zurückzuholen.":
    "Tap a word to take it out of the game or bring it back.",
  "Ein Wort, am besten mit zwei Bedeutungen": "One word, ideally with two meanings",
  "Wörtern kommen aufs Spielfeld.": "words can land on the board.",
  "Einladung läuft": "Waiting for answers",
  "Alle lesen ihr Wort": "Everyone is reading their word",
  "Läuft gerade": "In play",
  "Runde vorbei": "Round over",
  "zugesagt": "in",
  "offen": "undecided",
  "Runde": "Round",
  "Ich bin dabei": "I am in",
  "Diesmal nicht": "Not this time",
  "Du bist dabei.": "You are in.",
  "Doch nicht": "Actually, no",
  "Du hast abgesagt.": "You turned it down.",
  "Doch dabei": "Actually, yes",
  "Spiel starten": "Start the game",
  "Spiel beenden": "End the game",
  "Neue Runde": "New round",
  "Das Spiel ist beendet.": "The game has ended.",
  "Spiel beenden? Einladung und Zusagen verschwinden.":
    "End the game? The invitation and everyone's answers disappear.",
  "Für ein Spiel braucht es mindestens drei Leute.":
    "A game needs at least three people.",
  "Lade mindestens zwei Personen ein.": "Invite at least two people.",
  "Euer Wort": "Your word",
  "Du bist der Impostor": "You are the impostor",
  "Dein Tipp": "Your hint",
  "Du bist erst in der nächsten Runde dabei.":
    "You are in from the next round on.",
  "Merke es dir und drücke weiter.": "Remember it, then carry on.",
  "Weiter": "Carry on",
  "Es fehlen noch": "Still waiting for",
  "Gleich geht es los …": "About to start …",
  "Reihenfolge": "Turn order",
  "Wortschatz": "Words",
  "alle Kategorien": "all categories",
  "Nichts gewählt heißt: alle Wörter.": "Nothing picked means: every word.",
  "Spielzeit": "Time on the clock",
  "Minuten": "minutes",
  "Rateversuche für den Impostor": "Guesses for the impostor",
  "Versuch": "guess",
  "Versuche": "guesses",
  "Wort erraten?": "Know the word?",
  "Dein Tipp …": "Your guess …",
  "Raten": "Guess",
  "Leider nicht.": "Not it.",
  "Schreibe ein Wort.": "Write a word.",
  "Keine Versuche mehr - halte durch.": "No guesses left — hold out.",
  "Erraten! Der Impostor gewinnt.": "Guessed it! The impostor wins.",
  "Falsch geraten - der Impostor verliert.": "Wrong guess — the impostor loses.",
  "Falsch geraten": "Wrong guess",
  "Alarm! Der Impostor hat verloren.": "Time! The impostor has lost.",
  "Die Zeit ist um": "Time is up",
  "Der Impostor hat gewonnen": "The impostor won",
  "Das Wort war": "The word was",
  "war der Impostor": "was the impostor",
  "waren die Impostoren": "were the impostors",
  "Geraten": "Guessed",
  "Dieses Wort nicht mehr verwenden": "Do not use this word again",
  "Wort kommt nicht mehr dran.": "That word is out of the game.",
  "Wortliste": "Word list",
  "Eigenes Wort hinzufügen": "Add your own word",
  "Wort": "Word",
  "Tipp für den Impostor": "Hint for the impostor",
  "Die Richtung, nie das Wort selbst": "The direction, never the word itself",
  "Wieder zulassen": "Allow again",
  "Nicht mehr": "Retire",
  "Hier ist noch nichts.": "Nothing here yet.",
